            ...
            <div className="sm:w-[80%] border rounded-md">
                ...
                <div className="w-full justify-start flex p-3 pt-6">
                    ...
                    <div className="mx-10 text-sm sm:text-base">
                        ...
                        <p className="mb-2"><strong>{selectedOrder.date}</strong></p>
                        <p className={`mb-2 ${selectedOrder.urgency === "רגילה" ? "text-green-500 " : "text-red-500"} ${selectedOrder.urgency === "נמוכה" ? "text-blue-400" : ""}`}><strong>{selectedOrder.urgency}</strong></p>
                        <p className="mb-2"><strong>{selectedOrder.branch}</strong></p>
                        <p className="mb-2"><strong>{selectedOrder.order_type == null ? "לא זמין סוג הזמנה" : selectedOrder.order_type}</strong></p>
                        <p className="mb-2"><strong>{selectedOrder.created_at}</strong></p>
                        <p className="mb-2"><strong>{selectedOrder.time}</strong></p>
                        <p className="mb-2 break-all"><strong>
